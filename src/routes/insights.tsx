  ...
  return (
    <AppShell>
      ...
      <p className="mt-2 text-muted-foreground">
        A monthly view of your habits and where to focus next.
      </p>
      ...
      <section className="mt-8 grid gap-6 md:grid-cols-3">
        <article className="rounded-3xl border border-border bg-card p-6">
          ...
          <p className="mt-1 font-display text-4xl">
            {monthly.toFixed(1)} <span className="text-base text-muted-foreground">kg</span>
          </p>
        </article>
        <article className="rounded-3xl border border-border bg-card p-6">
          <p className="text-xs uppercase tracking-widest text-muted-foreground">Annualised pace</p>
          <p className="mt-1 font-display text-4xl">
            {annualised.toLocaleString()}{" "}
            <span className="text-base text-muted-foreground">kg / yr</span>
          </p>
        </article>
        <article className="rounded-3xl border border-border bg-card p-6">
